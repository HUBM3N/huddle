"Scheme"
{
	...
	"Fonts"
	{
		...
		"DefaultFixedOutline" //edited by INsane 2010 for small netgraph font on all screen sizes
		{
            ...
            {
                "name"	"squarefont" [$WINDOWS] // Standard is "Lucida Console" Options are "Microsoft Sans Serif" "Georgia" "Impact" "Segoe UI MT" and the best for small = "Haettenschweiler" but is a MS office and Win7 font, can be downloaded, google "Haettenschweiler" and install in C:/Windows/Fonts
	...
	"CustomFontFiles"
	{
        ...
        "2"	{	"font"	"resource/fonts/square.ttf"	"name"	"squarefont"	}
	}
}